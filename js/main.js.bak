	...
	var transforms = [	// First array holds global transforms, following are per scene
		...
		[ //scene 8 - aquarium
		 ...
		 [ //scene 11 
			...
			{id:document.getElementById("lights-out"), start: 11.73, end: 11.76, x: 1, y: 0, type:"opacity"},
		 ...
		 [ //scene 13 - celebration 
		  ...
		  {id:document.getElementById("celebration"), start: 13.0, end: 13.4, x:0, y: -600, type:"translate"},
			...
			{id:document.getElementById("text-celebration"), start: 13.6, end: 13.65, x:1, y: 0, type:"opacity"},
			{id:document.getElementById("celebration-light"), start: 13.5, end: 13.6, x:1, y: 0, type:"opacity"},
			{id:document.getElementById("globe"), start: 13.6, end: 13.75, x:0, y: 681, type:"translate"},
			{id:document.getElementById("celebration"), start: 13.6, end: 13.76, x:0, y: 650, type:"translate"},
			{id:document.getElementById("celebrationbg"), start: 13.6, end: 13.76, x:0, y: 100, type:"bgShift"}
		 ],
		 ...
		 [ //scene 14 - sky
			...
			{id:document.getElementById("text-sky-2"), start: 14.8, end: 14.9, x:-1, y: 0, type:"opacity"},
			{id:document.getElementById("questions-large"), start: 14.0, end: 14.1, x:1, y: 0, type:"opacity"},
			{id:document.getElementById("questions-large"), start: 14.5, end: 14.6, x:-1, y: 0, type:"opacity"},
			...
			{id:document.getElementById("questions-medium"), start: 14.5, end: 14.6, x:-1, y: 0, type:"opacity"},
			...
			{id:document.getElementById("questions-small"), start: 14.5, end: 14.6, x:-1, y: 0, type:"opacity"},
