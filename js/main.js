...
window.onload = function() {
	...
	var transforms = [	// First array holds global transforms, following are per scene
		...
		[  // scene 4	
			...
			{id:document.getElementById("bunny-2"), start: 4.4, end: 4.52, x: -1000, y: 0, type:"translate"},
			{id:document.getElementById("bunny-big"), start: 4.4, end: 4.52, x: -1000, y: 0, type:"translate"},
			{id:document.getElementById("know-your-memes"), start: 4.4, end: 4.52, x: -1000, y: 0, type:"translate"},
