...
window.onload = function() {
	...
	var transforms = [	// First array holds global transforms, following are per scene
		...
		[ 	//scene 6
			...
			{id:document.getElementById("clouds-1"), start: 6.4, end: 6.99, x: 300, y: 20, type:"translate"},
			{id:document.getElementById("feeling-it"), start: 6.45, end: 6.5, x:1, y: 0, type:"opacity"},
			{id:document.getElementById("drummers"), start: 6.28, end: 6.4, x: 0, y: -400, type:"translate"},
			{id:document.getElementById("hippies"), start: 6.20, end: 6.4, x: 0, y: -400, type:"translate"},
