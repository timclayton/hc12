...
window.onload = function() {
	...
	var transforms = [	// First array holds global transforms, following are per scene
		...
		[  // scene 2
			...
			{id:document.getElementById("lights"), start:2.6, end:2.8, x: 800, y:-1000, type:"translate"},
			...
			{id:document.getElementById("back-row-houses"), start:2.8, end:2.9, x: 0, y:-30, type:"translate"},
			{id:document.getElementById("front-row-houses"), start:2.8, end:2.9, x: 0, y:-40, type:"translate"},
			{id:document.getElementById("lawn-ornaments"), start:2.8, end:2.9, x: 0, y:-35, type:"translate"},
			{id:document.getElementById("lights"), start:2.8, end:2.9, x: 0, y:-20, type:"translate"},
